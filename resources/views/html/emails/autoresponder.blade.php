...
@section('title', __('kreatif-forms::forms.autoresponder_title'))

@section('content')

    <p>{{ __('kreatif-forms::forms.hello') }},</p>

    <h2>{{ __('kreatif-forms::forms.autoresponder_title') }}</h2>

    <p>{{ __('kreatif-forms::forms.autoresponder_intro') }}</p>

    <p>{{ __('kreatif-forms::forms.autoresponder_data_intro') }}</p>
    ...
    <p>{{ __('kreatif-forms::forms.regards') }},<br>
        {{ __('kreatif-forms::forms.the_team') }}</p>
@endsection
